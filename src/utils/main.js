...
addToCartBtn?.addEventListener('click', (e) => {
  ...
  let itemsCounter = getComputedStyle(document.documentElement).getPropertyValue('--items-counter').replace(/"|"/g, '');

  console.log(itemsCounter);
  // eslint-disable-next-line
  document.documentElement.style.setProperty('--items-counter', `\'${++itemsCounter}\'`);
